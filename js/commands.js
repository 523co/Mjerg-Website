...
var COMMANDS = [
  ...
  { name: "statschannel", args: "<members|online|off>", cat: "info", perms: "Manage community",
    desc: "A channel that keeps a live count in its own name",
    example: "statschannel members" },
  ...
  { name: "globalrich", cat: "fun",
    desc: "Coin leaderboard across every community Mjerg is in" },
  ...
  /* --- levelling --- */
  { name: "chatty", args: "[page]", cat: "levelling",
    desc: "Who actually talks the most in this community" },
  { name: "globalleaderboard", args: "[page]", cat: "levelling",
    desc: "XP ranking across every community at once" },
  { name: "globalrank", args: "[user]", cat: "levelling",
    desc: "Level, XP, and position on the global ladder" },
  { name: "leaderboard", args: "[page]", cat: "levelling", aliases: ["lb"],
    desc: "XP ranking for the community" },
  { name: "levelrole", args: "<add|remove> <level> <role id>", cat: "levelling", perms: "Manage roles",
    desc: "Hand out a role automatically when someone hits a level. Role IDs come from !roles" },
  ...
  { name: "forward", args: "<message id> <channel id>", cat: "moderation", perms: "Manage messages",
    desc: "Move a message to a more appropriate channel" },
  { name: "inrole", args: "<role id>", cat: "moderation",
  ...
  { name: "mute", args: "<user> [duration] [reason]", cat: "moderation", perms: "Moderate members",
    desc: "Stop a member from talking, for a set time or until unmuted",
    example: "mute @sam 1h cool off" },
  { name: "mutes", cat: "moderation", perms: "Moderate members",
    desc: "Everyone currently muted, and when each mute runs out" },
  ...
  { name: "role", args: "<add|remove> <user> <role id>", cat: "moderation", perms: "Manage roles",
    desc: "Add or take away a role. Role IDs come from !roles" },
  { name: "roles", cat: "moderation",
    desc: "Every role in the community, with its ID and member count" },
  ...
  { name: "unmute", args: "<user>", cat: "moderation", perms: "Moderate members",
    desc: "Lift a mute early" },
  ...
  /* --- setup --- */
  { name: "announce", args: "<channel id> <message>", cat: "setup", perms: "Manage community",
    desc: "Post an announcement as Mjerg" },
  { name: "autorole", args: "<role id|off>", cat: "setup", perms: "Manage roles",
    desc: "Give every new member a role on join" },
  { name: "autotranslate", args: "<channel id> <language|off>", cat: "setup", perms: "Manage community",
    desc: "Translate a whole channel as people post in it" },
  { name: "channel", args: "<log|welcome|suggestions|starboard> <channel id|off>", cat: "setup", perms: "Manage community",
    desc: "Point Mjerg's channels wherever you want them. Channel IDs, not #mentions" },
  { name: "config", cat: "setup", perms: "Manage community",
    desc: "Every setting for this community on one screen" },
  { name: "leave", cat: "setup", perms: "Manage community",
    desc: "Make Mjerg leave this community" },
  { name: "managerole", args: "<role id|off>", cat: "setup", perms: "Manage community",
    desc: "Which role counts as a Mjerg manager" },
  { name: "reactionrole", args: "<message id> <emoji> <role id>", cat: "setup", perms: "Manage roles",
    desc: "React to a message, get a role" },
  { name: "sticky", args: "<channel id> <message|off>", cat: "setup", perms: "Manage community",
  ...
  { name: "welcome", args: "<message|off>", cat: "setup", perms: "Manage community",
    desc: "What new members get greeted with when they join",
    example: "welcome hey {user}, read the rules first" },

  /* --- dev --- */
  { name: "echoto", args: "<channel id> <text>", cat: "dev", perms: "Bot owner",
